...
namespace Shopping.Aggregator.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        public async Task<IEnumerable<CatalogModel>> GeCatalog()
        {
        ...
        public async Task<CatalogModel> GeCatalog(string id)
        {
        ...
        public async Task<IEnumerable<CatalogModel>> GeCatalogByCategory(string category)
        {
